...
function setup() {
  ...
  fan1= new Ground(140,300,20,130)                                                                   
  World.add(world,fan1)

  fan2=new Ground(210,120,110,40)
World.add(world,fan2)

fan3=new Ground(240,190,10,420)
World.add(world,fan3)

fan4=new Ground(210,120,110,40)
World.add(world,fan4)

fan5=new Ground(310,20,10,140)
World.add(world,fan5)
